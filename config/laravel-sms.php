...
return [
    ...
    */
    'validation' => [
        'phone' => [
            ...
            'staticRules' => [
                // 不重复的手机号码，用于短信注册
                'register'     => 'required|zh_mobile|unique:customers,phone',
                'reset_password' => 'required|zh_mobile|exists:customers,phone', // 重置密码
            ],
        ],
    ],
    ...
    */
    ...
    |
    */
    'content' => SmsManager::closure(function ($code, $minutes, $input) {
    ...
    */
    ...
    |       }
    |
    | 如需缓存配置，则需使用 `Toplan\Sms\SmsManager::closure($closure)` 方法对匿名函数进行配置
    |
    */
    'data' => [
